...
public class MatrixTest {
    ...
    public static void main(String[] args) {
        ...
        MatrixNoda a = new MatrixNoda(arrayForMatrixA);
        MatrixNoda b = new MatrixNoda(arrayForMatrixB);
        MatrixNoda c = new MatrixNoda(arrayForMatrixC);

        MatrixNoda d = new MatrixNoda(3, 2);
        ...
        System.out.println(MatrixNoda.sum(a, b));

        System.out.println("matrix product a * b:");
        System.out.println(MatrixNoda.product(a, b));
