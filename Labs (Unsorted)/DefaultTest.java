...
public class DefaultTest {
    ...
    public DefaultTest(double[][] array) {
    ...
    public DefaultTest(int rows, int columns) {
    ...
    public static DefaultTest sum(DefaultTest a, DefaultTest b) {
        if ((a.numRows() != b.numRows()) || (a.numCols() != b.numCols()))
            return null;
        DefaultTest sum = new DefaultTest(a.numRows(), a.numCols());
    ...
    public static DefaultTest product(DefaultTest a, DefaultTest b) {
        if ((a.numRows() != b.numCols()) || (a.numCols() != b.numRows()))
            return null;
        DefaultTest product = new DefaultTest(a.numRows(), b.numCols());
    ...
    public DefaultTest subMatrix(int deletedRow, int deletedCol) {
        if ((deletedRow >= matrix.length) || (deletedCol >= matrix[0].length) || (matrix.length == 1)
                || (matrix[0].length == 1)) {
            return null;
        }

        DefaultTest subMatrix = new DefaultTest(matrix.length - 1, matrix[0].length - 1);
